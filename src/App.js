      ...
      <div className="row">
        <div className="col-lg-6 col-md-6 col-12">
          <form action="#" method="get" className="contact-form webform" role="form">
            ...
            <div className="form-group d-flex flex-column-reverse">
              <textarea className="form-control" rows={5} name="cf-message" id="cf-message" placeholder="Your Message" defaultValue={""} />
        ...
        <div className="mx-auto col-lg-4 col-md-6 col-12">
          ...
          <ul className="social-links mt-2">
            <li><a href="https://fb.com/tooplate" rel="noopener" className="fab fa-facebook" /></li>
            <li><a href="#" rel="noopener" className="fab fa-twitter" /></li>
            <li><a href="#" rel="noopener" className="fab fa-instagram" /></li>
            <li><a href="#" rel="noopener" className="fab fa-linkedin" /></li>
            <li><a href="#" rel="noopener" className="fab fa-youtube" /></li>
          </ul>
          <p className="copyright-text mt-5 pt-3">Copyright © 2020 Ben Resume Page</p>
